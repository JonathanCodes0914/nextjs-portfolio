        ...
        <div className={styles.sectionWrapper}>
            ...
            <div className={styles.sectionLeftRightWrapper}>
                ...
                <div className={styles.SectionRight}>
                    ...
                    <img width="600px" height="400px" src="https://static.scientificamerican.com/blogs/cache/file/9AA1FDBC-48FB-40FE-862C56A719C20CB8_source.jpg?w=590&h=800&73F8F0AF-4951-4631-82A9E1FF83FEBA00' alt='planet image"/>
